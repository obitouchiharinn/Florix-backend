...
const app = express();
const PORT = process.env.PORT || 8080; // Updated default port to 8080 common for containers
const HOST = '0.0.0.0'; // Explicit binding required for Railway
...
// Prevent Railway from thinking the process ended/timeouts
